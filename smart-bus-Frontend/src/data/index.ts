// ──────────────────────────────────────────────
//  data/index.ts
//  البيانات الوهمية (mock data) للتطبيق كله
//  لما يكون عندك API حقيقي، هتبدّل الـ arrays دي
//  بـ fetch calls وهتفضل باقي الكود زي ما هو
// ──────────────────────────────────────────────
